...
int main(int argc, char **argv) {
  ...
  GLFWwindow *window = glfwCreateWindow(1280, 720, "Dear ImGui Triangle Demo", NULL, NULL);
  if (window == NULL) {
    return 1;
  }
  ...
  triangle_shader.init(FileManager::read("shaders/simple-shader.vs"),
                       FileManager::read("shaders/simple-shader.fs"));
